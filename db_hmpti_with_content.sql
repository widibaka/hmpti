...
-- Dumping data for table db_hmpti.h_events: ~3 rows (approximately)
...
INSERT INTO `h_events` (`id_event`, `thumbnail`, `judul`, `jadwal`, `poster`, `deskripsi`, `publish`, `author`, `last_update`, `limit_pendaftar`) VALUES
	(1624963579, 'thumb-1624963579.jpg?1624964280', 'SIBARMATI - Sinau CRUD Bareng', 1622291400, 'poster-1624963579.jpg?1624963838', '<p>Belajar bareng tentang CRUD memakai bahasa pemrograman PHP.</p>', 1, 'WIDI DWI NURCAHYO', 1624965403, 0),
	(1624963850, 'thumb-1624963850.jpg?1624964180', 'SIBARMATI - Sinau Deployment Bareng', 1624798800, 'poster-1624963850.jpg?1624964180', '<p>Sinau bareng cara set up deploy website berbasis PHP secara otomatis memakai GITLAB CI</p>', 1, 'WIDI DWI NURCAHYO', 1624965388, 0),
	(1624965855, 'thumb-1624965855.jpg?1624966103', 'WEBINAR ANDROID FUNDAMENTAL', 1617429600, 'poster-1624965855.jpg?1624965983', '<p>Kegiatan ini dilaksanakan oleh Divisi Minat dan\r\nBakat Himpunan Mahasiswa Prodi Teknik Informatika Fakultas Ilmu Komputer Universitas\r\nDuta Bangsa Surakarta, yang di ikuti oleh Mahasiswa Fakultas Ilmu Komputer\r\nUniversitas Duta Bangsa Surakarta dan umum, kuota perserta yaitu 450 orang dengan\r\npendaftar sejumlah mendaftar 339, konfirmasi 295 yang hadir<br></p>', 1, 'WIDI DWI NURCAHYO', 1624966103, 0);
...
-- Dumping data for table db_hmpti.h_jabatan: ~10 rows (approximately)
...
-- Dumping data for table db_hmpti.h_member: ~17 rows (approximately)
...
INSERT INTO `h_member` (`nim`, `email`, `nama`, `kelas`, `id_jabatan`, `kontak`, `deskripsi`, `image`, `aktif`) VALUES
	...
	(180103167, 'yulidar_maulana@fikom.udb.ac.id', 'Yulidar Maulana Ivan Saputra', '18TIA1', 15, '', 'Yulidar Maulana Ivan Saputra. Menjabat sebagai anggota HMP TI UDB periode 2021.', '', 1),
...
-- Dumping data for table db_hmpti.h_member_login_log: ~3 rows (approximately)
...
-- Dumping data for table db_hmpti.h_panitia: ~19 rows (approximately)
...
-- Dumping data for table db_hmpti.h_proker: ~25 rows (approximately)
