...
-- Dumping data for table db_hmpti.h_events: ~4 rows (approximately)
...
INSERT INTO `h_events` (`id_event`, `thumbnail`, `judul`, `jadwal`, `poster`, `deskripsi`, `publish`, `author`, `last_update`, `limit_pendaftar`) VALUES
	(1, 'thumb-1.jpg?1614017357', 'Kumo ver.2', 1614214800, 'poster-1.jpg?1614016587', '<p><span xss="removed" style="background-color: rgb(255, 255, 0);">500 </span>laba-laba <strike>menggigit</strike></p>', 1, 'WIDI DWI NURCAHYO', 1614019700, 0),
	(2, 'thumb-2.jpg?1614018170', 'Kumo desu ga, Nani ka', 1614038700, 'poster-2.jpg?1614018550', 'Honkai Impact 4.1 sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.', 0, 'WIDI DWI NURCAHYO', 1614019178, 0),
	(3, 'thumb-3.jpg?1614018364', 'Matematika', 1614223200, 'poster-3.jpg?1614018364', 'Honkai Impact 4.1 sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.', 1, 'WIDI DWI NURCAHYO', 1614018685, 0),
...
-- Dumping data for table db_hmpti.h_member_login_log: ~7 rows (approximately)
...
-- Dumping data for table db_hmpti.h_panitia: ~1 rows (approximately)
...
INSERT INTO `h_panitia` (`id_panitia`, `email`, `id_event`, `peran`) VALUES
	(1, 'widi_dwi@fikom.udb.ac.id', 1, 'Staf');
